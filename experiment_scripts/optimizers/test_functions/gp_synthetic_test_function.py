...
RETURNS
 ...
 """
    ...
    def __init__(self, noise_std: Optional[float] = None,
        ...
        self.covar_module.base_kernel.lengthscale = hypers['covar_module.base_kernel.lengthscale']
        self.covar_module.outputscale = hypers['covar_module.outputscale']
    ...
    def optimize_optimal_value(self):
        ...
        res = [minimize(wrapped_evaluate_true_fun, x0=x0, method='nelder-mead', tol=1e-9) for x0 in
