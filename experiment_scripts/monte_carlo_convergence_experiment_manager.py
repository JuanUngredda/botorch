...
def run_experiment(
    ...
    acquisition_function = mo_acq_wrapper(method=method,
                                          ...
                                          num_scalarizations=num_scalarizations ,
    ...
    output = {
        "problem": problem,
        "method": method,
        "number_of_fantasies": num_fantasies,
        "number_of_discrete_points": num_X_discretisation,
        "num_scalarizations": num_scalarizations,
...
def main(exp_names, seed):
    ...
    NUMBER_SCALARIZATIONS = CONFIG_DICT[EXPERIMENT_NAME]["number_of_scalarizations"]
    ...
    for idx, _ in enumerate(EXPERIMENTS):
        ...
        file_name = script_dir + "/results/" + EXPERIMENT_NAME + "/" + EXPERIMENTS[idx][0] + "/" + EXPERIMENTS[idx][
            1] + "/" + EXPERIMENTS[idx][2] + "_" + str(EXPERIMENTS[idx][3]) + "_" + str(EXPERIMENTS[idx][4]) + "_" + str(EXPERIMENTS[idx][5])+"/" + str(seed) + ".pkl"
        ...
        if os.path.isfile(file_name) == False:
            run_experiment(
                ...
                num_fantasies=int(EXPERIMENTS[idx][3]),
                num_X_discretisation=int(EXPERIMENTS[idx][4]),
                num_scalarizations = int(EXPERIMENTS[idx][5]),
                savefile=script_dir + "/results/" + EXPERIMENT_NAME + "/" + EXPERIMENTS[idx][0] + "/" + EXPERIMENTS[idx][1] + "/"+
        EXPERIMENTS[idx][2] + "_" + str(EXPERIMENTS[idx][3]) + "_" + str(EXPERIMENTS[idx][4])+"_" + str(EXPERIMENTS[idx][5]),
                base_seed=seed,
            )
