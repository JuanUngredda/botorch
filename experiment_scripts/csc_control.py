...
# probably remove later. This, for some reason, make it work in the work computer.
# sys.path.insert(0, "/home/jungredda/miniconda3/envs/hybridKGProject/lib/python3.9/site-packages/")
# sys.path.insert(0,"/home/jungredda/Documents/GITHUB_REPOS/botorch")
# sys.path.insert(0,"/home/jungredda/miniconda3/envs/hybridKGProject/lib/python3.9/site-packages/gpytorch/utils")

sys.path.insert(0, "/home/jungredda/miniconda3/envs/botorch/lib/python3.11/site-packages/")
sys.path.insert(0,"/home/jungredda/CRYPT/GITHUB_REPOS/botorch")
sys.path.insert(0,"/home/jungredda/miniconda3/envs/botorch/lib/python3.11/site-packages/gpytorch/utils")
# print(sys.path)
# raise
...
def run(args):
    ...
    import experiment_manager_computational_comparison as experiment_manager
    ...
    seed = 0
    while True:
        experiment_names = ["DISCKG"]

        for exp_name in experiment_names:

            if args.k + seed > 99:
                raise
            experiment_manager.main(experiment_name=exp_name, seed=args.k + seed)
