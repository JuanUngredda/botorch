...
U = range(len(ALL_CSC_NAMES))#[0, 1, 2, 4, 5, 6, 7, 8, 9, 10, 11] #'[2,3,6,7,10,11]#range(len(ALL_CSC_NAMES)) #[3, 5, 6, 7]#[3,6,7]##[1, 2, 3, 6] #[0, 4, 5, 7, 8]  # range(len(ALL_CSC_NAMES)) #[3,4, 9, 10, 11]#
