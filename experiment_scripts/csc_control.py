...
def run(args):
    ...
    seed = 0
    while True:
        experiment_names = [ "BNH_10_scalar_experiments", "SRN_10_scalar_experiments",
        ...
        experiment_names = ["SRN_experiments"]#["BNH_experiments", "SRN_experiments", "ConstrainedBraninCurrin_experiments"]
